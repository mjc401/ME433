...
void APP_USBDeviceEventHandler(USB_DEVICE_EVENT event, void * eventData, uintptr_t context)
{
    ...
    switch(event)
    {
        ...
        case USB_DEVICE_EVENT_DECONFIGURED:
            ...
            BSP_LEDOn ( 7 );//APP_USB_LED_1 );
            BSP_LEDOn ( 15 );//APP_USB_LED_2 );
        ...
        case USB_DEVICE_EVENT_CONFIGURED:
            ...
            if(configurationValue->configurationValue == 1)
            {
                ...
                BSP_LEDOff ( 7 );//APP_USB_LED_1 );
                BSP_LEDOn ( 15 );//APP_USB_LED_2 ); //Off
        ...
        case USB_DEVICE_EVENT_SUSPENDED:
            BSP_LEDOn ( 7 );//APP_USB_LED_1 ); //Off
            BSP_LEDOff ( 15 );//APP_USB_LED_2 ); //On
            //BSP_LEDOn ( APP_USB_LED_3 );
            break;
...
void APP_Tasks ( void )
{
    ...
    short accels[3];
    int xpix,ypix,xpix_mouse,ypix_mouse;
    ...
    //sprintf(x_dir,"V = %c",x_acc_dir);
    //sprintf(y_dir,"H = %c",y_acc_dir);
    //display_clear();
...
//            }
            ...
            if(appData.emulateMouse)
            {
                ...
                if(movement_length > 30)
                {
                    if(BSP_SWITCH_STATE_PRESSED == (BSP_SwitchStateGet( 13 ))){
                        ...
                        appData.xCoordinate = ypix_mouse;//(int8_t)dir_table[vector & 0x07] ;
                        appData.yCoordinate = xpix_mouse;//(int8_t)dir_table[(vector+2) & 0x07];
                        //vector ++;
                        movement_length = 0;
                    }
                    else{
            ...
            {
                   if(BSP_SWITCH_STATE_PRESSED == (BSP_SwitchStateGet( 13 ))){
                    appData.mouseButton[0] = MOUSE_BUTTON_STATE_PRESSED;//MOUSE_BUTTON_STATE_RELEASED;
                    appData.mouseButton[1] = MOUSE_BUTTON_STATE_RELEASED;
                    appData.xCoordinate = 0;
                    appData.yCoordinate = 0;
                   }
                   else{
                        appData.mouseButton[0] = MOUSE_BUTTON_STATE_RELEASED;//MOUSE_BUTTON_STATE_RELEASED;
                    appData.mouseButton[1] = MOUSE_BUTTON_STATE_RELEASED;
                    appData.xCoordinate = 0;
                    appData.yCoordinate = 0;
                   }
